<?php $__env->startSection('isi-halaman'); ?>
    ...
    <section class="container">
        <div class="cat-prestasi">
            ...
            <div class="row">
                <?php if(isset($dataPrestasi) && sizeof($dataPrestasi) > 0): ?>
                    <?php $__currentLoopData = $dataPrestasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="card">
                                <img src="<?php echo e(asset($item->photo)); ?>" class="card-img-top" alt="..."/>
                                <div class="card-body">
                                    ...
                                    <div class="popup" id="popup<?php echo e($item->id); ?>">
                                        ...
                                        <div class="popup-content">
                                            <img
                                                src="<?php echo e(asset($item->photo)); ?>"
                                                class="card-img-top"
                                                alt="pict1"
                                            />
...
<?php echo $__env->make('template.prestasi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\1. Perkuliahan\Semester 5\PABW\proyekKelompok\project-spmb-pabwe\resources\views/prestasi/prestasiDosenStaff.blade.php ENDPATH**/ ?>