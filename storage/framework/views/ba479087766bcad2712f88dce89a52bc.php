...
<div class="modal fade" id="tambah_tombol_hero_section_modal" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('addPrestasi')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH D:\1. Perkuliahan\Semester 5\PABW\project-spmb-pabwe\resources\views/admin-panel/sub_admin_panel/tambah_prestasi.blade.php ENDPATH**/ ?>