<?php $__env->startSection('isi-halaman'); ?>
    ...
    <section id="hero" class="container-fluid">
        <div class="gambar-hero">
            <img src="<?php echo e(asset($dataHeroSection->bg_image)); ?>" alt="Your Image">
            <div class="content-inside d-none d-md-inline">
                <h1 class="display-5 fw-bold text-white text"><?php echo e($dataHeroSection->header); ?></h1>
                <br>
                <p class="lead mb-4"><?php echo nl2br($dataHeroSection->paragraph); ?></p>
    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            <div class="col-10 col-sm-8 col-lg-6">
                    <img src="<?php echo e($dataAkreditasiInstitusi->sertifikat_akreditasi ? asset($dataAkreditasiInstitusi->sertifikat_akreditasi) : asset("assets/img/default.jpg")); ?>"
                         class="d-block n shadow-lg mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500"
                         loading="lazy">
            </div>
            <div class="col-lg-6">
                <h1 class=" fw-bold lh-1 mb-3"><?php echo e($akreditasiDashboard->header); ?></h1>
                <p class="lead">
                    <?php echo e($akreditasiDashboard->description); ?>

                </p>
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <a href="<?php echo e(asset($dataAkreditasiInstitusi->sertifikat_akreditasi ? : 'assets/img/default.jpg')); ?>"
        ...
        <div id="carouselExampleCaptions" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo e(asset("/assets/img/beasiswa-tolikara.jpeg")); ?>" class="d-block w-100"
    ...
    <script>
        ...
        animateCount('jumlah-dosen', 0, <?php echo e($dataInstitusi->jumlah_dosen); ?>, 100);
        animateCount('jumlah-mahasiswa', 0, <?php echo e($dataInstitusi->jumlah_mahasiswa); ?>, 100);
        animateCount('jumlah-alumni', 0, <?php echo e($dataInstitusi->jumlah_alumni); ?>, 100);
    </script>
    ...
    <section id="mitra-kampus" class="splide container p-5" aria-label="Beautiful Images">
                ...
                <ul class="splide__list">
                    <li class="splide__slide d-flex justify-content-center" data-splide-interval="2000">
                        <div class="card border-0 p-2 d-flex align-items-center justify-content-center"
                             style="<?php echo e($lebarCardMitra); ?>">
                            <img src="<?php echo e(asset("/assets/img/logo-huawei.png")); ?>" class="card-img-top"
                                 alt="logo-huawei">
                        </div>
                    </li>
                    ...
                    <li class="splide__slide d-flex justify-content-center" data-splide-interval="2000">
                        <div class="card border-0 p-2 d-flex align-items-center justify-content-center"
                             style="<?php echo e($lebarCardMitra); ?>">
                            <img src="<?php echo e(asset("/assets/img/logo-apple.png")); ?>" class="card-img-top" alt="logo-huawei">
                        </div>
                    </li>
                    ...
                    <li class="splide__slide d-flex justify-content-center" data-splide-interval="2000">
                        <div class="card border-0 p-2 d-flex align-items-center justify-content-center"
                             style="<?php echo e($lebarCardMitra); ?>">
                            <img src="<?php echo e(asset("/assets/img/logo-samsung.png")); ?>" class="card-img-top"
                                 alt="logo-huawei">
                        </div>
                    </li>
                    ...
                    <li class="splide__slide d-flex justify-content-center" data-splide-interval="2000">
                        <div class="card border-0 p-2 d-flex align-items-center justify-content-center"
                             style="<?php echo e($lebarCardMitra); ?>">
                            <img src="<?php echo e(asset("/assets/img/bank_mandiri.png")); ?>" class="card-img-top"
                                 alt="logo-huawei">
                        </div>
                    </li>
                    ...
                    <li class="splide__slide d-flex justify-content-center" data-splide-interval="2000">
                        <div class="card border-0 p-2 d-flex align-items-center justify-content-center"
                             style="<?php echo e($lebarCardMitra); ?>">
                            <img src="<?php echo e(asset("/assets/img/bank_jenius.png")); ?>" class="card-img-top"
                                 alt="logo-huawei">
                        </div>
                    </li>
                </ul>
        ...
        <div class="d-flex w-100 justify-content-center">
            <a href="<?php echo e(route('mitra.mitra')); ?>" class="btn btn-primary mt-5">See More</a>
        </div>
    </section>
    ...
    <section id="testimoni" class="splide container bg-informasi-umum p-5" aria-label="Beautiful Images">
        ...
        <div class="splide__slider">
            <div class="splide__track">
                <ul class="splide__list">
                    <li class="splide__slide d-flex justify-content-center" data-splide-interval="2000">
                        <div class="card" style="<?php echo e($lebarCard); ?>">
                            <div class="bg-primary bg-image-container card-img-top"></div>
                            <div class="d-flex justify-content-center">
                                <div class="image-container">
                                    <img src="<?php echo e(asset("/assets/img/profil.jpg")); ?>" class="cropped-image"
                                         alt="foto-profil">
                                </div>
                            </div>
                            <div class="card-body">
...
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project-spmb-pabwe\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>