...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset("/assets/css/admin_panel.css")); ?>">
...
<body>
    ...
    <div class="d-flex w-100">
        ...
        <div class="d-none ps-3 pe-3 fixed-top bg-sidebar d-flex flex-column align-items-center" id="sidebar_besar" style="width: 18rem; height: 100vh">
            ...
            <div class="d-flex flex-column row-gap-3 w-100">
                ...
                <a href="<?php echo e(route("admisi-panel")); ?>">
                    <button id="btn_dashboard_panel" class="btn_sidebar w-100 text-start">
        ...
        <div class="w-100">
            <nav class="navbar shadow-sm fixed-top navbar-expand-lg bg-body-tertiary border border-bottom-1">
                <div class="container-fluid">
                    ...
                    <div class="mx-auto">
                        <a href="<?php echo e(route('admin-panel')); ?>" class="text-decoration-none text-black">
                    ...
                    <div class="btn-group">
                        <button type="button" style="border-style: none;" class="ps-1 bg-light dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false">
                            <span class="me-3">Haloo <?php echo e($admin->firstname); ?></span>
                            <img class="border border-1 border-primary" src="<?php echo e(asset($admin->profile_pict)); ?>" alt="foto_profil" style="width: 40px; border-radius: 50%">
                            <span class="visually-hidden">Toggle Dropdown</span>
                        </button>
                        <ul class="dropdown-menu mt-3 dropdown-menu-end">
                            <li><a class="dropdown-item" href="<?php echo e(route('edit-profile')); ?>"><i class="bi bi-person me-2"></i>Edit Profile</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('dashboard')); ?>" target="_blank"><i class="bi bi-house me-2 me-2"></i>SPMB Dashboard</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('logout')); ?>"><i class="bi bi-box-arrow-left me-2"></i> Logout</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
            ...
            <div style="padding-top: 60px">
                <?php echo $__env->yieldContent('isi-admin-panel'); ?>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        buttonSidebar[<?php echo e($indexActive); ?>].classList.add("btn_sidebar_active");
        buttonSidebarKecil[<?php echo e($indexActive); ?>].classList.add("btn_sidebar_active");
    </script>
    ...
    <script src="<?php echo e(asset("/assets/js/admin-panel.js")); ?>"></script>
</body>
</html>
<?php /**PATH D:\1. Perkuliahan\Semester 5\PABW\proyekKelompok\project-spmb-pabwe\resources\views/template/admin-panel-template.blade.php ENDPATH**/ ?>