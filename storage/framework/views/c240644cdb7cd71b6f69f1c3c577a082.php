    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo e(asset("/assets/img/gambar-hero-2.jpg")); ?>" class="d-block w-100 blur-image" alt="gambar-1">
        ...
        <div class="splide__track">
            <ul class="splide__list">
                <li class="splide__slide d-flex justify-content-center" data-splide-interval="2000">
                    <div class="card border-0 p-2 d-flex align-items-center justify-content-center" style="<?php echo e($lebarCardMitra); ?>" >
                        <img src="<?php echo e(asset("/assets/img/logo-huawei.png")); ?>" class="card-img-top" alt="logo-huawei">
                    </div>
                </li>
                ...
                <li class="splide__slide d-flex justify-content-center" data-splide-interval="2000">
                    <div class="card border-0 p-2 d-flex align-items-center justify-content-center" style="<?php echo e($lebarCardMitra); ?>" >
                        <img src="<?php echo e(asset("/assets/img/logo-samsung.png")); ?>" class="card-img-top" alt="logo-huawei">
                    </div>
                </li>

                <li class="splide__slide d-flex justify-content-center" data-splide-interval="2000">
                    <div class="card border-0 p-2 d-flex align-items-center justify-content-center" style="<?php echo e($lebarCardMitra); ?>" >
                        <img src="<?php echo e(asset("/assets/img/bank_mandiri.png")); ?>" class="card-img-top" alt="logo-huawei">
                    </div>
                </li>

                <li class="splide__slide d-flex justify-content-center" data-splide-interval="2000">
                    <div class="card border-0 p-2 d-flex align-items-center justify-content-center" style="<?php echo e($lebarCardMitra); ?>" >
                        <img src="<?php echo e(asset("/assets/img/bank_jenius.png")); ?>" class="card-img-top" alt="logo-huawei">
                    </div>
                </li>
            </ul>
        </div>
                    ...
                    <div class="card" style="<?php echo e($lebarCard); ?>" >
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="image-container">
                                <img src="<?php echo e(asset("/assets/img/profil.jpg")); ?>" class="cropped-image" alt="foto-profil">
                            </div>
                        </div>
                        <div class="card-body">
...
<div id="chat-container" style="position: fixed; bottom: 20px; right: 20px; z-index: 1000;">
  <div id="chat-button" style="width: 100px; height: 105px; border-radius: 0; color: #fff; text-align: center; line-height: 70px; cursor: pointer; position: relative; overflow: hidden; transition: transform 0.5s ease-in-out;" onclick="toggleChatForm()" onmouseover="this.style.transform='scale(1.1)'" onmouseout="this.style.transform='scale(1)'">
    <img src="<?php echo e(asset("/assets/img/icon2.png")); ?>" style="width: 100%; height: 100%; object-fit: cover; position: absolute; top: 0; left: 0; transition: transform 0.5s ease-in-out;" class="d-block w-100" alt="gambar-1">
  </div>
...
<script src="<?php echo e(asset("/assets/js/chatbot.js")); ?>"></script>
...
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\1. Perkuliahan\Semester 5\PABW\proyekKelompok\project-spmb-pabwe\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>