...
use \App\Http\Controllers\DropdownAdmisiController;
...
Route::delete('/removeJadwalPendaftaran/{jadwalPendaftaran_id}', [AdmisiController::class, 'removeJadwalPendaftaran'])->name('remove_JadwalPendaftaran');
...
Route::post('/addDropdown', [DropdownAdmisiController::class, 'addDropdown'])->name('addDropdown');
Route::post('/editDropdown', [DropdownAdmisiController::class, 'editDropdown'])->name('editDropdown');
Route::delete('/deleteDropdown', [DropdownAdmisiController::class, 'deleteDropdown'])->name('deleteDropdown');
//});
