        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="inputJenisUjian" class="form-label">Jenis Tes</label>
                        <input type="text" class="form-control" id="inputJenisUjian" name="jenisUjian">
                    </div>
                    </form>
                </div>
