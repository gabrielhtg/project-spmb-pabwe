...
<div class="container mt-3">
    <div class="card mb-3">
        ...
        <div class="row g-0">
            ...
            <div class="col-md-8">
                <div class="card-body" style="height: 100%;"> <!-- Tambahkan style height: 100% di sini -->
                    <div class="card-text" style="text-align:justify; padding-right:20px; height: 100%;"> <!-- Tambahkan style height: 100% di sini -->
