<section class="container" id="areamahasiswa">
    ...
    <div class="costum-justified-text align items-center pt-3">
        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nisi quae quibusdam nemo a corrupti, amet maxime earum esse sint animi? Minus 
        accusantium magnam deleniti reprehenderit, iure voluptates quod commodi vitae.</p>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
        <img src="{{ asset('/assets/img/fasilitas/perpustakaan.jpg') }}" class="img-fluid custom-image" alt="asrama-pniel">
        </div>
