...
@section("isi-halaman")
        ...
        <div id="carouselExample" class="carousel slide">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img style="weight:100wh; height: 70vh;" src="{{ asset($dataHeaderAdmisi->letak_foto ?  : 'assets/img/default.jpg') }}"
    ...
    <section class="container w-100 pt-5 pb-3">
        ...
        @foreach($prodis as $prodi)
                <div type="button" class="bg-white border-0" data-bs-toggle="modal" data-bs-target="#exampleModal{{$prodi->id}}">
                    <div class="border-1 border d-flex rounded-5" style="width: 18rem; height: 7rem">
                        <div class="bg-body-tertiary rounded-start-5" style="width: 6rem">
                            <img src="{{ asset($prodi->cover) }}" alt="three-dot" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                ...
                <!-- Modal -->
                <div class="modal fade" id="exampleModal{{$prodi->id}}" tabindex="-1" aria-labelledby="exampleModalLabel{{$prodi->id}}" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content" style="width: 800px; height:600px">
                            <div class="modal-header" style="background-color: rgb(241, 241, 241)">
                                <h1 class="modal-title fs-5" id="exampleModalLabel{{$prodi->id}}" style="font-weight:900;">
