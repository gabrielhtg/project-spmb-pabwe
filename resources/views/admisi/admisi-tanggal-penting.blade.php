            ...
            <div class="d-flex flex-column align-items-center mt-4 justify-content-center">
                <div class="card-admisi shadow-lg p-4 rounded-4">
                    <ul class="nav nav-pills nav-fill" id="tab-tabeltanggalpenting" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="lokasi-tab" data-bs-toggle="tab" data-bs-target="#lokasi-tab-pane"
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade p-3" id="jadwal-ujian-tab-pane" role="tabpanel"
                            ...
                            <ul>
                                @foreach ($dataJadwalUjian as $e)
                                    <li>
                                        <span class="fw-semibold">Jadwal Pelaksanaan Ujian {{ $e->jalur_ujian }} Tahun
                                            Akademik {{ $e->tahun_akademik }}</span>
                                        <p>
                                            {!! $e->deskripsi !!}
                                        </p>
                                    </li>
                        ...
                        <div class="tab-pane fade" id="jenis-test-tab-pane" role="tabpanel" aria-labelledby="jenis-test-tab"
                            tabindex="0">
                            <table class="table table-striped table-bordered mt-5">
                                <tbody>
                        ...
                        <div class="tab-pane ps-3 pe-3 fade" id="lokasi-tab-pane" role="tabpanel"
                            aria-labelledby="lokasi-tab" tabindex="0">
                            <table class="table table-striped table-bordered mt-5">
                                <tbody>
