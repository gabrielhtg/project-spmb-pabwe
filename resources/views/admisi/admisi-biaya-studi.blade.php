    ...
    <section class="container text-center mt-5" id="bagianBiaya">
            ...
            <table class="table align-middle">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-white fw-semibold" style="background-color: #47A5D4">Program Studi
                        </th>
                        <th scope="col" class="text-white fw-semibold" style="background-color: #47A5D4">Biaya SPP (Rp)
                        </th>
                        <th scope="col" class="text-white fw-semibold" style="background-color: #47A5D4">Uang
                            Pengembangan (Rp) + N X 1000000 (min N = 1)</th>
                        <th scope="col" class="text-white fw-semibold" style="background-color: #47A5D4">Uang Pangkal
                            (Rp)</th>
                        <th scope="col" class="text-white fw-semibold" style="background-color: #47A5D4">Perlengkapan
                            Mahasiswa (Rp)</th>
                        <th scope="col" class="text-white fw-semibold" style="background-color: #47A5D4">Perlengkapan
                            Makan (Rp)</th>
                    </tr>
                        ...
                        @foreach ($groupedBiaya as $index => $biaya)
                            <tr>
                                ...
                                <td style="font-size: 13px;">
                                    {{ number_format($biaya->perlengkapan_mahasiswa, 0, ',', '.') }}</td>
                                <td style="font-size: 13px;">{{ number_format($biaya->perlengkapan_makan, 0, ',', '.') }}
                                </td>
                            </tr>
                        @endforeach
                    @endforeach
        ...
        <div class="d-flex justify-content-center flex-column pt-5 ">
            ...
            <table class="table align-middle table-bordered">
                <thead>
                    <tr>
                        <th scope="col" style="background-color: #47A5D4" class="text-white fw-semibold">Jalur
                            Pendaftaran</th>
            ...
            <table class="table align-middle">
                ...
                <tbody>
                    @foreach ($dataBiaya as $biaya)
                        ...
                        <tr>
                            <td>Biaya Deposit Toga (Rp) yang akan dikembalikan bila toga dikembalikan ke IT Del dalam
                                keadaan baik</td>
        ...
        <div class="d-flex justify-content-center flex-column pt-5 ">
            ...
            <table class="table align-middle table-bordered">
                <thead>
                    <tr>
                        <th scope="col" style="background-color: #47A5D4" class="text-white fw-semibold">Jenis Kegiatan
                        </th>
                        <th scope="col" style="background-color: #47A5D4" class="text-white fw-semibold">Jumlah SKS
                            Kegiatan</th>
                        <th scope="col" style="background-color: #47A5D4" class="text-white fw-semibold">Potongan SPP
                        </th>
                    </tr>
                </thead>
                <tbody>
