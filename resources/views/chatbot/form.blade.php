    ...
    <div class="row justify-content-center">
        <div class="form-container p-4">
            <form>
                ...
                <div class="form-group row">
                    <label for="nomor" class="col-md-4 col-form-label text-right">Nomor WhatsApp</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="nomor" name="nomor" placeholder="Masukkan nomor WhatsApp Anda">
                    </div>
                </div>
                <div class="form-group row">
        ...
        <div class="d-flex justify-content-evenly flex-wrap gap-3">
            ...
            <div class="section-footer d-flex justify-content-center mt-3 d-md-none">
                <div class="d-flex gap-3">
                    ...
                    <img class="logo-footer-2-kecil" src="{{ asset("/assets/img/Logo Institut Teknologi Del.png") }}"
                         alt="Logo Yayasan Del">
                </div>
            </div>
